...
###### \- Application Layer: Servisler, arayüzler ve iş mantığı.

###### \- Infrastructure: Veritabanı erişimi ve dış servisler.

###### \- Web API: Dış dünyaya açılan kapı.
...
###### \- Sorumluluk: API geliştirme, Veritabanı tasarımı, Clean Architecture kurgusu.
...
###### \- Sorumluluk: Masaüstü arayüz tasarımı, API entegrasyonu.
